...
Pod::Spec.new do |s|
  s.name             = 'EasyPopUp'
  s.version          = '0.1.0'
  s.summary          = 'A short description of EasyPopUp.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Mohammad/EasyPopUp'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Mohammad' => 'mohammad_z74@icloud.com' }
  s.source           = { :git => 'https://github.com/Mohammad/EasyPopUp.git', :tag => s.version.to_s }
